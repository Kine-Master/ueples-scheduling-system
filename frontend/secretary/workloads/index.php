        ...
        <div class="split-layout">
            ...
            <aside class="teacher-panel">
                <div class="panel-header">
                    ...
                    <div class="search-box">
                        ...
                        <input type="text" id="searchTeacher" placeholder="Search...">
                    </div>
                </div>
            ...
            <section class="workspace-panel">
                ...
                <div id="emptyState" class="empty-state">
                    ...
                    <h2>Select a teacher to manage</h2>
                    <p>Click on a faculty member from the list to view their schedule.</p>
                </div>
                ...
                <div id="scheduleWorkspace" style="display:none;">
                    ...
                    <div class="ws-header">
                        ...
                        <div class="ws-actions">
                            ...
                            <button onclick="openAddModal()" class="btn-action btn-add">
                    ...
                    <div class="toolbar">
                        ...
                        <div id="gridLegend" class="legend-inline">
                            <span><span class="dot les"></span> LES (Editable)</span>
                            <span><span class="dot coed"></span> COED (Read Only)</span>
                        </div>
                    </div>
