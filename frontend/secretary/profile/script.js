    ...
    fetch('../../../backend/user/get_profile.php')
        ...
        .then(res => {
            if (res.status === 'success') {
                ...
                // Explicitly set Secretary role label
                document.getElementById('displayRole').innerText = 'SECRETARY'; 
                
                document.getElementById('displayDept').innerText = u.department || 'Scheduler';
