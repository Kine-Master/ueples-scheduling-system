...
<head>
  ...
  <style>
    ...
    /* Use a pseudo-element invisible bridge to prevent losing hover */
  ...
  <nav class="top-nav">
    ...
    <div class="nav-dropdown">
      ...
      <div class="nav-dropdown-content">
        ...
        <a href="index.php" style="color:var(--accent);background:var(--accent-bg)">Curricula</a>
...
<main class="page-content">
  <div class="page-header">
    <div class="page-header-text"><h2><i class="fa-solid fa-book" style="color:var(--accent)"></i> Curricula</h2><p>Manage curricular variants (e.g., General, Science, Special)</p></div>
    <div class="right"><button class="btn btn-primary" onclick="openAddModal()"><i class="fa-solid fa-plus"></i> Add Curriculum</button></div>
  </div>
  ...
  <div class="section-card">
    ...
    <div class="table-wrap">
      <table class="data-table">
        <thead><tr><th>#</th><th>Curriculum Name</th><th>Grade Level</th><th>Description</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody id="currBody"><tr class="no-data"><td colspan="6"><div class="spinner-wrap"><i class="fa-solid fa-spinner"></i><p>Loading…</p></div></td></tr></tbody>
      </table>
    </div>
  </div>
</main>
...
<div class="modal-overlay" id="currModal">
  <div class="modal modal-sm">
    <div class="modal-header"><h3 id="modalTitle"><i class="fa-solid fa-plus"></i> Add Curriculum</h3><button class="modal-close" onclick="closeModal('currModal')"><i class="fa-solid fa-xmark"></i></button></div>
