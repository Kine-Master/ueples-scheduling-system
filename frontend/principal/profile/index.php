    ...
    <div class="section-card">
      ...
      <div style="padding:24px">
        ...
        <form id="profileForm" onsubmit="saveProfile(event)">
          ...
          <div class="form-group"><label class="form-label">Academic Rank</label><input class="form-control" id="pRank" placeholder="e.g. Principal IV"></div>
          <div class="form-group"><label class="form-label">School / College</label><input class="form-control" id="pSchool" placeholder="e.g. UEP LES"></div>
