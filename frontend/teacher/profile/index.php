    ...
    <main class="main-content-centered">
        ...
        <div class="profile-container">
            ...
            <div class="profile-card">
                ...
                <span class="role-badge" id="displayRole">TEACHER</span>
                    ...
                    <form id="profileForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="school_college" id="schoolCollege" placeholder="e.g. College of Education">
                            </div>
                        </div>

                        <div class="input-group">
                            <label>Department</label>
                            <input type="text" name="department" id="department" placeholder="e.g. Science Dept">
                        </div>
