...
// 1. IDENTITY SECURITY
// We strictly use the Session ID. The teacher cannot print other people's reports.
...
// 7. GROUP SCHEDULES BY SUBJECT + TIME
$grouped = [];
$totalHoursGlobal = 0;
...
// 8. CALCULATE TOTALS (Count units only ONCE per unique subject+classtype combination)
$countedSubjects = [];
$totalLec = 0;
$totalLab = 0;
...
<head>
  <script>
    ...
    <meta charset="UTF-8">
    <title>My Workload - <?= e($teacher['last_name']) ?></title>
    <style>
